...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" id="formDetail" role="form" action="/admin/new-detail/edit-new/{{ $data->id }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group" id="divImage">
                ...
                <div class="form-group col-md-4 text-center">
                    <img src="/upload/news/{{ $item->name_image }}" height="160px">
